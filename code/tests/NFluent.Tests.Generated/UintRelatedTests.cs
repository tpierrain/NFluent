...
namespace NFluent.Tests
{
    ...
    public class UintRelatedTests
    {
        ...
        public void NotEqualsThrowsExceptionWhenFailing()
        {
            ...
            .IsAFailingCheckWithMessage(Environment.NewLine+ "The checked value is equal to the given one whereas it must not." + Environment.NewLine + "The expected value: different from" + Environment.NewLine + "\t[20] of type: [uint]");
        }
        ...
        public void HasValueThrowsExceptionWhenFailing()
        {
            Check.ThatCode(() =>
            {
                Check.That((uint?) null).HasAValue();
        ...
        {
            Check.That((uint?) null).Not.HasAValue();
        }
        ...
        {
            Check.ThatCode(() => { Check.That((uint?) null).Not.HasAValue().Which.IsAfter(Zero); })
        ...
        {
            Check.That((uint?) null).HasNoValue();
        }
        ...
        public void NotHasNoValueThrowsExceptionWhenFailing()
        {
            Check.ThatCode(() =>
            {
                Check.That((uint?) null).Not.HasNoValue();
            })
            .IsAFailingCheckWithMessage("",
        ...
        public void IsInstanceOfWorksWithNullable()
        {
            ...
            Check.That(one).IsInstanceOf<uint?>().And.HasAValue().Which.IsEqualTo(1);
        }
        ...
        public void IsInstanceOfThrowsExceptionWhenFailingWithNullable()
        {
            Check.ThatCode(() =>
            {
                Check.That((uint?) null).IsInstanceOf<string>();
            })
            .IsAFailingCheckWithMessage("",
        ...
        public void IsNotInstanceOfWorksWithNullable()
        {
            ...
            Check.That(one).IsNotInstanceOf<uint>().And.HasAValue().Which.IsEqualTo(1);
        }
