...
namespace NFluent.Tests
{
    ...
    public class ByteRelatedTests
    {
        ...
        public void NotEqualsThrowsExceptionWhenFailing()
        {
            ...
            .IsAFailingCheckWithMessage(Environment.NewLine+ "The checked value is equal to the given one whereas it must not." + Environment.NewLine + "The expected value: different from" + Environment.NewLine + "\t[20] of type: [byte]");
        }
        ...
        public void HasValueThrowsExceptionWhenFailing()
        {
            Check.ThatCode(() =>
            {
                Check.That((byte?) null).HasAValue();
        ...
        {
            Check.That((byte?) null).Not.HasAValue();
        }
        ...
        {
            Check.ThatCode(() => { Check.That((byte?) null).Not.HasAValue().Which.IsAfter(Zero); })
        ...
        {
            Check.That((byte?) null).HasNoValue();
        }
        ...
        public void NotHasNoValueThrowsExceptionWhenFailing()
        {
            Check.ThatCode(() =>
            {
                Check.That((byte?) null).Not.HasNoValue();
            })
            .IsAFailingCheckWithMessage("",
        ...
        public void IsInstanceOfWorksWithNullable()
        {
            ...
            Check.That(one).IsInstanceOf<byte?>().And.HasAValue().Which.IsEqualTo(1);
        }
        ...
        public void IsNotInstanceOfWorksWithNullable()
        {
            ...
            Check.That(one).IsNotInstanceOf<byte>().And.HasAValue().Which.IsEqualTo(1);
        }
