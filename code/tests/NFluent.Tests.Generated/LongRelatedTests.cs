...
namespace NFluent.Tests
{
    ...
    public class LongRelatedTests
    {
        ...
        public void NotEqualsThrowsExceptionWhenFailing()
        {
            ...
            .IsAFailingCheckWithMessage(Environment.NewLine+ "The checked value is equal to the given one whereas it must not." + Environment.NewLine + "The expected value: different from" + Environment.NewLine + "\t[20] of type: [long]");
        }
        ...
        public void HasValueThrowsExceptionWhenFailing()
        {
            Check.ThatCode(() =>
            {
                Check.That((long?) null).HasAValue();
        ...
        {
            Check.That((long?) null).Not.HasAValue();
        }
        ...
        public void HasValueSupportsToBeChainedWithTheWhichOperator()
        {
            ...
            Check.That(one).HasAValue().Which.IsAfter(Zero).And.IsEqualTo(1L);
        }
        ...
        {
            Check.That((long?) null).HasNoValue();
        }
        ...
        public void NotHasNoValueThrowsExceptionWhenFailing()
        {
            Check.ThatCode(() =>
            {
                Check.That((long?) null).Not.HasNoValue();
            })
            .IsAFailingCheckWithMessage("",
        ...
        public void IsInstanceOfWorksWithNullable()
        {
            ...
            Check.That(one).IsInstanceOf<long?>().And.HasAValue().Which.IsEqualTo(1L);
        }
        ...
        public void NotIsInstanceOfWorksWithNullable()
        {
            ...
            .IsAFailingCheckWithMessage("",
                    "The checked nullable is an instance of [long?] whereas it must not.",
                    "The checked nullable:",
                    "\t[1] of type: [long?]",
                    "The expected value: different from",
                    "\tan instance of [long?]");
        ...
        {
            Check.ThatCode(()=>
                Check.That((long?) null).IsInstanceOf<long?>()).IsAFailingCheckWithMessage("", 
        ...
        {
            Check.That((long?) null).Not.IsInstanceOf<long?>();
        }
        ...
        public void IsInstanceOfThowsExceptionWhenFailingWithNullable()
        {
            Check.ThatCode(() =>
            {
                Check.That((long?) null).IsInstanceOf<string>();
            })
            .IsAFailingCheckWithMessage("",
        ...
        public void IsNotInstanceOfWorksWithNullable()
        {
            ...
            Check.That(one).IsNotInstanceOf<long>().And.HasAValue().Which.IsEqualTo(1L);
        }
        ...
        {
            Check.That((long?) null).IsNotInstanceOf<long?>();
        }
