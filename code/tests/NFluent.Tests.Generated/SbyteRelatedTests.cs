...
namespace NFluent.Tests
{
    ...
    public class SbyteRelatedTests
    {
        ...
        public void NotEqualsThrowsExceptionWhenFailing()
        {
            ...
            .IsAFailingCheckWithMessage(Environment.NewLine+ "The checked value is equal to the given one whereas it must not." + Environment.NewLine + "The expected value: different from" + Environment.NewLine + "\t[20] of type: [sbyte]");
        }
        ...
        {
            Check.ThatCode(() => { Check.That((sbyte?) null).Not.HasAValue().Which.IsAfter(Zero); })
