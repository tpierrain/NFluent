...
namespace NFluent.Tests
{
    ...
    public class UshortRelatedTests
    {
        ...
        public void NotEqualsThrowsExceptionWhenFailing()
        {
            ...
            .IsAFailingCheckWithMessage(Environment.NewLine+ "The checked value is equal to the given one whereas it must not." + Environment.NewLine + "The expected value: different from" + Environment.NewLine + "\t[20] of type: [ushort]");
        }
        ...
        public void HasValueThrowsExceptionWhenFailing()
        {
            Check.ThatCode(() =>
            {
                Check.That((ushort?) null).HasAValue();
        ...
        {
            Check.That((ushort?) null).Not.HasAValue();
        }
        ...
        {
            Check.ThatCode(() => { Check.That((ushort?) null).Not.HasAValue().Which.IsAfter(Zero); })
        ...
        {
            Check.That((ushort?) null).HasNoValue();
        }
        ...
        public void NotHasNoValueThrowsExceptionWhenFailing()
        {
            Check.ThatCode(() =>
            {
                Check.That((ushort?) null).Not.HasNoValue();
            })
            .IsAFailingCheckWithMessage("",
        ...
        public void IsInstanceOfWorksWithNullable()
        {
            ...
            Check.That(one).IsInstanceOf<ushort?>().And.HasAValue().Which.IsEqualTo(1);
        }
        ...
        {
            Check.ThatCode(()=>
                Check.That((ushort?) null).IsInstanceOf<ushort?>()).IsAFailingCheckWithMessage("", 
        ...
        public void IsNotInstanceOfWorksWithNullable()
        {
            ...
            Check.That(one).IsNotInstanceOf<ushort>().And.HasAValue().Which.IsEqualTo(1);
        }
