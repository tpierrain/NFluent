...
namespace NFluent
{
    ...
    public static class UintCheckExtensions
    {
        ...
        public static ICheckLink<ICheck<uint>> IsAfter(this ICheck<uint> check, uint givenValue)
        {
            ExtensibilityHelper.BeginCheck(check)
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<uint>> IsGreaterOrEqualThan(this ICheck<uint> check, uint givenValue)
        {
            return new NumberCheck<uint>(check).IsGreaterOrEqualThan(givenValue);
        }
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<uint>> IsLessOrEqualThan(this ICheck<uint> check, uint givenValue)
        {
            return new NumberCheck<uint>(check).IsLessOrEqualThan(givenValue);
        }
        ...
        {
            return new NumberCheck<uint>(check).IsStrictlyLessThan(comparand);
        }
