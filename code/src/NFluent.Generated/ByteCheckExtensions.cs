...
namespace NFluent
{
    ...
    public static class ByteCheckExtensions
    {
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<byte>> IsGreaterOrEqualThan(this ICheck<byte> check, byte givenValue)
        {
            return new NumberCheck<byte>(check).IsGreaterOrEqualThan(givenValue);
        }
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<byte>> IsLessOrEqualThan(this ICheck<byte> check, byte givenValue)
        {
            return new NumberCheck<byte>(check).IsLessOrEqualThan(givenValue);
        }
