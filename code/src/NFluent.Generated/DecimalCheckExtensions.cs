...
namespace NFluent
{
    ...
    public static class DecimalCheckExtensions
    {
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<decimal>> IsGreaterOrEqualThan(this ICheck<decimal> check, decimal givenValue)
        {
            return new NumberCheck<decimal>(check).IsGreaterOrEqualThan(givenValue);
        }
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<decimal>> IsLessOrEqualThan(this ICheck<decimal> check, decimal givenValue)
        {
            return new NumberCheck<decimal>(check).IsLessOrEqualThan(givenValue);
        }
