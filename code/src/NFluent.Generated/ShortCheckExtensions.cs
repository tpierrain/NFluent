...
namespace NFluent
{
    ...
    public static class ShortCheckExtensions
    {
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<short>> IsGreaterOrEqualThan(this ICheck<short> check, short givenValue)
        {
            return new NumberCheck<short>(check).IsGreaterOrEqualThan(givenValue);
        }
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<short>> IsLessOrEqualThan(this ICheck<short> check, short givenValue)
        {
            return new NumberCheck<short>(check).IsLessOrEqualThan(givenValue);
        }
