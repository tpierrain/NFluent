...
namespace NFluent
{
    ...
    public static class UlongCheckExtensions
    {
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<ulong>> IsGreaterOrEqualThan(this ICheck<ulong> check, ulong givenValue)
        {
            return new NumberCheck<ulong>(check).IsGreaterOrEqualThan(givenValue);
        }
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<ulong>> IsLessOrEqualThan(this ICheck<ulong> check, ulong givenValue)
        {
            return new NumberCheck<ulong>(check).IsLessOrEqualThan(givenValue);
        }
