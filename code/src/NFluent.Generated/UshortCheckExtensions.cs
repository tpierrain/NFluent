...
namespace NFluent
{
    ...
    public static class UshortCheckExtensions
    {
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<ushort>> IsGreaterOrEqualThan(this ICheck<ushort> check, ushort givenValue)
        {
            return new NumberCheck<ushort>(check).IsGreaterOrEqualThan(givenValue);
        }
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<ushort>> IsLessOrEqualThan(this ICheck<ushort> check, ushort givenValue)
        {
            return new NumberCheck<ushort>(check).IsLessOrEqualThan(givenValue);
        }
        ...
        {
            return new NumberCheck<ushort>(check).IsZero();
        }
        ...
        {
            return new NumberCheck<ushort>(check).IsStrictlyLessThan(comparand);
        }
        ...
        {
            return new NumberCheck<ushort>(check).IsStrictlyGreaterThan(comparand);
        }
    }
}
