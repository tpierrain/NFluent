...
namespace NFluent
{
    ...
    public static class SbyteCheckExtensions
    {
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<sbyte>> IsGreaterOrEqualThan(this ICheck<sbyte> check, sbyte givenValue)
        {
            return new NumberCheck<sbyte>(check).IsGreaterOrEqualThan(givenValue);
        }
        ...
        /// </returns>
        /// <exception cref="FluentCheckException">The current value is not after the other one.</exception>
        public static ICheckLink<ICheck<sbyte>> IsLessOrEqualThan(this ICheck<sbyte> check, sbyte givenValue)
        {
            return new NumberCheck<sbyte>(check).IsLessOrEqualThan(givenValue);
        }
