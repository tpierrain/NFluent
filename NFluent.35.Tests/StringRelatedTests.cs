...
namespace NFluent.Tests
{
    ...
    public class StringRelatedTests
    {
        ...
        public void LongStringErrorMessageIsProperlyTruncated()
        {
            ...
            {
                checkString = streamReader.ReadToEnd();
            }

            string expectedString;
            using (StreamReader streamReader = new StreamReader("ExpectedFile.xml", Encoding.UTF8))
            {
                expectedString = streamReader.ReadToEnd();
            }
