...
namespace NFluent
{
    ...
    public static class ShortSignedCheckExtensions
    {
        ...
        public static ICheckLink<ICheck<short>> IsGreaterThanZero(this ICheck<short> check)
        {
            var numberCheckStrategy = new NumberCheck<short>(check);
            return numberCheckStrategy.IsGreaterThanZero();
        }
        ...
        public static ICheckLink<ICheck<short>> IsLessThanZero(this ICheck<short> check)
        {
            var numberCheckStrategy = new NumberCheck<short>(check);
            return numberCheckStrategy.IsNegative();
        }
