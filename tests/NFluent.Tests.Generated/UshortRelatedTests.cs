...
#pragma warning restore 618
        ...
        public void NotEqualsThrowsExceptionWhenFailing()
        {
            ...
            .IsAFaillingCheckWithMessage(Environment.NewLine+ "The checked value is equal to the expected one whereas it must not." + Environment.NewLine + "The expected value: different from" + Environment.NewLine + "\t[20] of type: [ushort]");
        }
        ...
        {
            Check.That((ushort?) null).IsInstanceOf<ushort?>();
        }
