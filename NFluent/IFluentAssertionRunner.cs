...
namespace NFluent
{
    ...
    public interface IFluentAssertionRunner<out T>
    {
        ...
        IChainableFluentAssertion<IFluentAssertion<T>> ExecuteAssertion(INegatedAndForkableAssertion fluentAssertion, Action action, string negatedExceptionMessage);
    }
}