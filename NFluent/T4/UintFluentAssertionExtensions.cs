...
namespace NFluent
{
    ...
    public static class UintFluentAssertionExtensions
    {
        ...
        public static IChainableFluentAssertion<IFluentAssertion<uint>> IsEqualTo(this IFluentAssertion<uint?> fluentAssertion, object expected)
        {
            ...
            if (value != null)
            {
                IFluentAssertion<uint> fakePreviousAssertion = new FluentAssertion<uint>((uint)value);
                return new ChainableFluentAssertion<IFluentAssertion<uint>>(fakePreviousAssertion);
            }
            else
            {
                return null;
        ...
        public static void IsNull(this IFluentAssertion<uint?> fluentAssertion)
        {
            var assertionRunner = fluentAssertion as IFluentAssertionRunner<uint?>;
            IRunnableAssertion<uint?> runnableAssertion = fluentAssertion as IRunnableAssertion<uint?>;
        ...
        public static void IsNotNull(this IFluentAssertion<uint?> fluentAssertion)
        {
            var assertionRunner = fluentAssertion as IFluentAssertionRunner<uint?>;
            IRunnableAssertion<uint?> runnableAssertion = fluentAssertion as IRunnableAssertion<uint?>;
