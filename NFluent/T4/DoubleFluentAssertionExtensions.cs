...
namespace NFluent
{
    ...
    public static class DoubleFluentAssertionExtensions
    {
        ...
        public static IChainableFluentAssertion<IFluentAssertion<double>> IsEqualTo(this IFluentAssertion<double?> fluentAssertion, object expected)
        {
            ...
            if (value != null)
            {
                IFluentAssertion<double> fakePreviousAssertion = new FluentAssertion<double>((double)value);
                return new ChainableFluentAssertion<IFluentAssertion<double>>(fakePreviousAssertion);
            }
            else
            {
                return null;
