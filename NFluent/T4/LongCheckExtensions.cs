...
namespace NFluent
{
    ...
    public static class LongCheckExtensions
    {
        ...
        public static ICheckLink<ICheck<long?>> IsInstanceOf<T>(this ICheck<long?> check)
        {
            ...
            return new CheckLink<ICheck<long?>>(check);
        }
        ...
        {
            var checkRunner = check as ICheckRunner<long>;
            var runnableCheck = check as IRunnableCheck<long>;
        ...
        public static ICheckLink<ICheck<long>> IsAfter(this ICheck<long> check, IComparable givenValue)
        {
            var checkRunner = check as ICheckRunner<long>;
            var runnableCheck = check as IRunnableCheck<long>;
            IComparable checkedValue = runnableCheck.Value as IComparable;
