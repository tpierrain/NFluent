// // --------------------------------------------------------------------------------------------------------------------
// // <copyright file="NullableNumberFluentAssertion.cs" company="">
...
namespace NFluent
{
    ...
    public class NullableNumberFluentAssertion<N> : IFluentAssertion<N>, IRunnableAssertion<N>, IFluentAssertionRunner<N> where N : struct/*, IComparable*/
    {
        ...
        public NullableNumberFluentAssertion(IFluentAssertion<N> fluentAssertion)
        {
        ...
        {
            return new NullableNumberFluentAssertion<N>(this.fluentAssertion);
        }
