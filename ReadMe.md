...
NFluent is __directly inspired by the awesome Java FEST Fluent__ assertion/reflection library (__http://fest.easytesting.org/__) which had been recently forked (by one of its most active contributor) to create the more prolific __[AssertJ](https://github.com/joel-costigliola/assertj-core)__ library.
