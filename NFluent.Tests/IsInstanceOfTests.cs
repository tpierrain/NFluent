namespace NFluent.Tests
{
    ...
    public class IsInstanceOfTests
    {
        ...
        [Test]
        [ExpectedException(typeof(FluentAssertionException), ExpectedMessage = "The checked value is not an instance of the expected type.\nThe checked value:\n\t[Telemachus] of type: [NFluent.Tests.Child]\nThe expected type:\n\t[NFluent.Tests.Person]")]
        ...
        [Test]
        [ExpectedException(typeof(FluentAssertionException), ExpectedMessage = "The checked value is an instance of System.Int32 whereas it must not.\nThe checked value:\n\t[23] of type: [System.Int32]\nThe expected type: different from\n\t[System.Int32]")]
        ...
        [Test]
        [ExpectedException(typeof(FluentAssertionException), ExpectedMessage = "The checked value is an instance of System.String whereas it must not.\nThe checked value:\n\t[\"If you don’t want to slip up tomorrow, speak the truth today (Bruce Lee).\"] of type: [System.String]\nThe expected type: different from\n\t[System.String]")]
        ...
        [Test]
        [ExpectedException(typeof(FluentAssertionException), ExpectedMessage = "The checked value is an instance of System.TimeSpan whereas it must not.\nThe checked value:\n\t[01:00:00] of type: [System.TimeSpan]\nThe expected type: different from\n\t[System.TimeSpan]")]
        ...
        [Test]
        [ExpectedException(typeof(FluentAssertionException), ExpectedMessage = @"The checked expression type does not have the expected inheritance.
